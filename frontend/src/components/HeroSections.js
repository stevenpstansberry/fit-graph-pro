        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography variant="body1" sx={{ color: "#555" }}>
                Enter your goal weight and let our advanced regression models
                analyze your workout data to forecast when you’ll hit your next
                PR. Track your progress with precision and see results in
                real-time.
              </Typography>
              <Typography variant="body1" sx={{ mt: 2, color: "#555" }}>
                With at least 50 sets logged, we'll give you an accurate
                estimate of when you’ll reach your goals based on data-driven
                insights.
              </Typography>
            </Box>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <Typography variant="body1" sx={{ color: "#555" }}>
                Easily estimate your 1-rep max (1RM) using our advanced
                algorithm. We analyze your heaviest sets and reps to calculate
                your maximum strength potential.
              </Typography>
              <Typography variant="body1" sx={{ mt: 2, color: "#555" }}>
                Powered by Epley’s formula, we give you accurate 1RM predictions
                based on your workout history, helping you plan your next big
          ...
          >
            ...
            >
              ...
              >
                ...
                It highlights which areas of your body have been worked the
                most, helping you balance your workouts and avoid overtraining.
              </Typography>
            </Box>
          </motion.div>
        </Box>
...
/**
 * ShimmerTypography component that displays a shimmering text animation as the user scrolls.
 *
 * @component
 * @returns {React.Element} - A styled text element with a shimmer effect that fades in based on scroll position.
 *
 */
  ...
  return (
    <motion.div
      ...
      style={{
        opacity,
        background:
          "linear-gradient(90deg, #FFD700 25%, #fff 50%, #FFD700 75%)",
