  ...
  if (active && payload && payload.length && payload[0].payload.workout) {
    ...
    return (
      ...
      >
        ...
        {/* Render WorkoutDetailsCard for the hovered workout */}
      </div>
    );
  }
...
const StrengthChart = ({
  ...
  useEffect(() => {
    ...
    if (timeframe === "currentMonth") {
      ...
      dataToDisplay = workoutHistory.filter(
        (workout) => workout.date.getFullYear() === selectedYear
      );
        ...
        <>
              ...
              <Grid container spacing={2} sx={{ mt: 2 }}>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Max Weight:</strong> {stats.maxWeight} lbs
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Average Weight:</strong> {stats.averageWeight} lbs
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Max Reps:</strong> {stats.maxReps}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Total Volume:</strong> {stats.totalVolume} lbs
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Average Volume per Workout:</strong>{" "}
                    {stats.averageVolumePerWorkout} lbs
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Workout Count:</strong> {stats.workoutCount}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <Typography variant="body1">
                    <strong>Predicted 1RM:</strong> {stats.maxPredicted1RM} lbs
                  </Typography>
                </Grid>
              </Grid>
            </Collapse>
          ...
          <ResponsiveContainer width="100%" height={400}>
            ...
            >
              ...
              {/* Use custom tooltip for displaying workout details */}
              <Legend />
              {showWeight && (
